...
public class PurchaseOrderException extends Throwable {
    ...
    protected PurchaseOrderException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
